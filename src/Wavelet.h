...
public:
     ...
     * @param vanishing_moment Wavelet vanishing_moment value to load well-known values.
     *          The vanishing_moment value must be within the supported range. Use
    ...
    /**
     * Return the minimum wavelet vanishing_moment value supported for well-known wavelet
    ...
    /**
     * Return the maximum wavelet vanishing_moment value supported for well-known wavelet
     * filter coefficients of a type of wavelet.
